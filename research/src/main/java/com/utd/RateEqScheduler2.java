 ...
 */
public class RateEqScheduler2 extends Thread {
    ...
    public RateEqScheduler2(int scenario){
        ...
        if(scenario == 1 || scenario == 2){
            for(Flow f: queues.keySet()){
                if(f.getFlowType() == FlowType.GREEDY){
                    f.setMinimumBandwidth(11 * 1024 * 1024 / Global.maxPacketLength);
            ...
            for(Flow f: queues.keySet()){
                if(f.getFlowType() == FlowType.GREEDY && f.getFlowId() < 28){
                    f.setMinimumBandwidth(7 * 1024 * 1024 / Global.maxPacketLength);
                    f.setAllocatedBandwidth(f.getMinimumBandwidth());
                }
                else if(f.getFlowType() == FlowType.UU_B_CR || f.getFlowType() == FlowType.UU_B_PR){
                    f.setAllocatedBandwidth(f.getMinimumBandwidth());
                }
                else{
                    f.setAllocatedBandwidth(f.getMinimumBandwidth());
            ...
            for(Flow f: queues.keySet()){
                if(f.getFlowType() == FlowType.GREEDY){
                    f.setMinimumBandwidth(13.75f * 1024 * 1024 / Global.maxPacketLength);
                    f.setAllocatedBandwidth(f.getMinimumBandwidth());
